...
export default function NewsfeedPage(){
    ...
    const fetchNewsfeeds = async ({ pageParam = 0 }: QueryFunctionContext) => {
        const response = await fetch(`https://funsns.shop:8000/feed-service/admin/feed/timeline?cursor=${pageParam}&size=5`, {
        headers: {
            "Credentials": "include",
        ...
        <div>
            ...
            <React.Fragment key={i}>
                ...
                <div key={newsfeed.feedId} className="bg-gray-50 flex justify-center p-6">
                    ...
                    <div className="mb-4">
                        <Link href={`/admin/newsfeed/detail/${newsfeed.feedId}`}>
