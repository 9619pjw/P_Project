...
export default function FeedDetailPage(props: ReadProps) {
    ...
    const editFeed = (e:React.MouseEvent) => {
        window.location.href = `/admin/newsfeed/detail/${props.params.id}/modify`;
    }
    // 피드 삭제 함수
        ...
        <div className="bg-gray-50 flex justify-center p-12">
            <div className="bg-white shadow-md rounded-lg w-full max-w-6xl flex">
                <div className="w-1/2 h-256">
                    <Link href={`/admin/newsfeed/detail/${feedData.feedId}`}>
                ...
                <div className="mb-4 flex flex-col space-y-4 py-4 border-b">
                    <Link href={`/admin/newsfeed/detail/${feedData.feedId}/likefeed`}>
